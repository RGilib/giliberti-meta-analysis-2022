...
ax1.set_ylabel('Dataset',fontsize=25)
ax1.set_xlabel('Number of samples',fontsize=25)
...
ax2.plot(x3, y, 'D',markersize=20, label= 'Relative abundance')
ax2.plot(x4, y, 'ro',markersize=16, label= 'Presence/Absence')
ax2.set_xlabel('AUC',fontsize=25)
...
ax3.plot(x7, y, 'D',markersize=20, label= 'Relative abundance')
ax3.plot(x8, y, 'ro',markersize=16, label= 'Presence/Absence')
ax3.set_xlabel('AUPRC',fontsize=25)
...
ax4.plot(x5, y, 'D',markersize=20, label= 'Relative abundance')
ax4.plot(x6, y, 'ro',markersize=16, label= 'Presence/Absence')
ax4.set_xlabel('Species, q < 0.05',fontsize=25)
...
fig.tight_layout()
plt.savefig('../results/fig_and_tables/Fig1.eps')
plt.savefig('../results/fig_and_tables/Fig1.png')

fig,(ax1)= plt.subplots(nrows=1, ncols=1,  figsize=(10,10))
ax1.scatter(x3,x4,s=55)
ax1.tick_params(axis='x', labelsize=18)
ax1.tick_params(axis='y', labelsize=18)

ax1.plot( [0,1],[0,1],"--r" )
fig.suptitle('AUC comparison', fontsize=20)
ax1.set_xlabel('AUC relative abundance',fontsize=20)
ax1.set_ylabel('AUC presence/absence',fontsize=20)
ax1.set_xlim(0.5,1)
ax1.set_ylim(0.5,1)


plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('../results/fig_and_tables/FigS1.eps')
plt.savefig('../results/fig_and_tables/FigS1.png')

fig,(ax1)=plt.subplots(nrows=1,ncols=1,figsize=(10,10))
ax1.scatter(x3,x7,marker='D',label='Relative abundance', s= 55)
ax1.scatter(x4,x8,marker='o',c='r',label='Presence/Absence', s = 45)
...
ax1.tick_params(axis='x', labelsize=18)
ax1.tick_params(axis='y', labelsize=18)
fig.suptitle('AUC vs AUPRC',fontsize=20)
ax1.legend(loc='best', prop={'size': 20}, labelspacing=1)
plt.tight_layout(rect=[0, 0, 1, 0.95])

plt.savefig('../results/fig_and_tables/FigS2.eps')
...
ax4.patch.set_edgecolor('grey')
plt.tight_layout()
plt.savefig('../results/fig_and_tables/Fig2.eps')
...
plt.savefig('../results/fig_and_tables/FigS4.eps')
...
ax1.plot(x, y, 'D',markersize=25, label= 'Threshold = 0.0%')
ax1.plot(x2, y, 'ro',markersize=22, label= 'Threshold = 0.0001%')
ax1.plot(x3, y, 'yd',markersize=19, label= 'Threshold = 0.001%')
ax1.plot(x4, y, 'bs',markersize=16, label= 'Threshold = 0.01%')
ax1.plot(x5, y, 'kX',markersize=13, label= 'Threshold = 0.1%')
ax1.set_ylabel('Dataset',fontsize=25)
ax1.set_xlabel('AUC difference:\n Presence/absence - Rel. abundance profiles',fontsize=24)
ax1.legend(loc='upper right', prop={'size': 15}, labelspacing=1)
ax1.set_facecolor('white')
ax1.tick_params(axis='y', labelsize=25)
ax1.tick_params(axis='x', labelsize=25)
...
ax2.plot(x, y, 'D',markersize=25, label= 'Threshold = 0.0%')
ax2.plot(x2, y, 'ro',markersize=22, label= 'Threshold = 0.0001%')
ax2.plot(x3, y, 'yd',markersize=19, label= 'Threshold = 0.001%')
ax2.plot(x4, y, 'bs',markersize=16, label= 'Threshold = 0.01%')
ax2.plot(x5, y, 'kX',markersize=13, label= 'Threshold = 0.1%')
...
plt.tight_layout()
plt.savefig('../results/fig_and_tables/Fig3.eps')
...
fig, (ax1)= plt.subplots(nrows=1, ncols=1,  sharey=True,  figsize=(20,20))
ax1.plot(x, y, 'D',markersize=25, label= 'Species')
ax1.plot(x2, y, 'ro',markersize=22, label= 'Genus')
ax1.plot(x3, y, 'yd',markersize=19, label= 'Family')
ax1.plot(x4, y, 'gs',markersize=16, label= 'Order')
ax1.set_ylabel('Dataset',fontsize=25)
ax1.set_xlabel('AUC difference:\n Presence/absence - Rel. abundance profiles',fontsize=25)
ax1.legend(loc='best', prop={'size': 20}, labelspacing=1)
ax1.set_facecolor('white')
ax1.tick_params(axis='y', labelsize=25)
ax1.tick_params(axis='x', labelsize=25)
...
plt.tight_layout()
plt.savefig('../results/fig_and_tables/Fig4.eps')
...
ax3.plot(x, y, 'D',markersize=25, label= 'Lasso')
ax3.plot(x2, y, 'ro',markersize=22, label= 'ENet')
ax3.plot(x3, y, 'yd',markersize=19, label= 'LSVM')
ax3.plot(x4, y, 'gs',markersize=16, label= 'SVM')
ax3.plot(x5, y, 'kX',markersize=13, label= 'RFs')
ax3.set_xlabel('AUC difference: \n Presence/absence - Rel. abundance profiles',fontsize=20)
ax3.legend(loc='best', prop={'size': 20}, labelspacing=1)
ax3.set_facecolor('white')
...
plt.tight_layout()
plt.savefig('../results/fig_and_tables/Fig5.eps')
...
fig, (ax1, ax2,ax3)= plt.subplots(nrows=1, ncols=3,  sharey=True,  figsize=(25,25))
ax1.plot(x2, y, 'D',markersize=28, label= 'Threshold = 0.0%')
ax1.plot(x6, y, 'ro',markersize=25, label= 'Threshold = 0.0001%')
ax1.plot(x5, y, 'yd',markersize=22, label= 'Threshold = 0.001%')
ax1.plot(x4, y, 'gs',markersize=19, label= 'Threshold = 0.01%')
ax1.plot(x3, y, 'kX',markersize=16, label= 'Threshold = 0.1%')
ax1.plot(x,y, '^', color='violet', markersize=13, label = 'Relative abundance')

ax1.set_ylabel('Dataset',fontsize=25)
ax1.set_xlabel('AUC',fontsize=25)
ax1.legend(loc='best', prop={'size': 16}, labelspacing=1)
ax1.set_facecolor('white')
ax1.tick_params(axis='y', labelsize=25)
ax1.tick_params(axis='x', labelsize=25)
ax1.set_xlim(0.40, 1)
...
ax2.plot(x, y, 'D',markersize=28, label= 'Genus - Species')
ax2.plot(x2, y, 'ro',markersize=25, label= 'Family - Species')
ax2.plot(x3, y, 'yd',markersize=22, label= 'Order - Species')

ax2.set_xlabel('AUC difference:\n AUC Taxonomic level - AUC Species',fontsize=25)
ax2.legend(loc='best', prop={'size': 16}, labelspacing=1)
ax2.set_facecolor('white')
ax2.tick_params(axis='y', labelsize=25)
ax2.tick_params(axis='x', labelsize=25)
...
ax3.plot(x, y, 'D',markersize=28, label= 'Species')
ax3.plot(x2, y, 'ro',markersize=25, label= 'Genus')
ax3.plot(x3, y, 'yd',markersize=22, label= 'Family')
ax3.plot(x4, y, 'gs',markersize=19, label= 'Order')
ax3.set_xlabel('AUC difference:\n Presence/absence - Rel. abundance profiles',fontsize=25)
ax3.legend(loc='best', prop={'size': 16}, labelspacing=1)
ax3.set_facecolor('white')
ax3.tick_params(axis='y', labelsize=25)
ax3.tick_params(axis='x', labelsize=25)
ax3.set_xlim(-0.5, 0.5)
...
plt.tight_layout()
plt.savefig('../results/fig_and_tables/Fig6.eps')
...
ax1.plot(x, y, 'D',markersize=25, label= 'CV-Abundance')
ax1.plot(x2, y, 'ro',markersize=22, label= 'Lodo-Abundance')
ax1.plot(x3, y, 'yd',markersize=19, label= 'CV-Presence/Absence')
ax1.plot(x4, y, 'gs',markersize=16, label= 'Lodo-Presence/Absence')
...
plt.tight_layout()
plt.savefig('../results/fig_and_tables/FigS9.eps')
...
fig, (ax1, ax2)= plt.subplots(nrows=1, ncols=2,  sharey=True,  figsize=(20,20))
ax1.plot(x, y, 'D',markersize=25, label= 'Lasso')
ax1.plot(x2, y, 'ro',markersize=22, label= 'ENet')
ax1.plot(x3, y, 'yd',markersize=19, label= 'LSVM')
ax1.plot(x4, y, 'gs',markersize=16, label= 'SVM')
ax1.set_ylabel('Dataset',fontsize=25)
...
ax2.plot(x, y, 'D',markersize=25, label= 'Lasso')
ax2.plot(x2, y, 'ro',markersize=22, label= 'ENet')
ax2.plot(x3, y, 'yd',markersize=19, label= 'LSVM')
ax2.plot(x4, y, 'gs',markersize=16, label= 'SVM')
ax2.set_xlabel('AUC difference:\n Selected classifier - RF classifier',fontsize=20)
ax2.legend(loc='best', prop={'size': 15}, labelspacing=1)
ax2.set_facecolor('white')
ax2.tick_params(axis='y', labelsize=25)
...
ax2.patch.set_edgecolor('grey')
plt.tight_layout()
plt.savefig('../results/fig_and_tables/FigS10.eps')
...
for i in range(len(dbs)):
    for j in range(len(level)):
        ...
        dm1 = pd.read_csv('../data/shotgun/'+level[j]+'/species/'+dbs[i]+'.txt', sep= '\t',index_col=0).T
        dm1 = dm1.loc[:, dm1.columns != 'study_condition'].astype(float).join(dm1['study_condition'])
        dm1 = dm1.groupby('study_condition').mean().T.reset_index()
...
color1 = plt.cm.YlOrRd_r(np.linspace( 0.50,1, 128))
color2 = plt.cm.Blues(np.linspace(0.25, 1, 128))
...
network_pal4 = plt.cm.Blues(np.linspace(0.25,1,11))
...
network_pal5 = plt.cm.YlOrRd(np.linspace(0 ,0.5, 7))
...
network_pal4 = plt.cm.Blues(np.linspace(0.25,1,7))
network_pal5 = plt.cm.YlOrRd(np.linspace(0 ,.5, 7))
...
plt.savefig('../results/fig_and_tables/FigS7.eps', format='eps',dpi=300 )
plt.savefig('../results/fig_and_tables/FigS7.png')
plt.savefig('../results/fig_and_tables/FigS7.svg', format='svg',dpi=300 )

color1 = (0.74, 0.71, 0.41,1) 
color2 =(0, 0, 1,1) 
...
plt.savefig('../results/fig_and_tables/FigS8.eps', format='eps',dpi=300 )
...
def pvalue_s(df):
    ...
    for i in range(len(df.columns)):
        ...
        pvals.append(tmp)
    return pd.DataFrame([i for i in pvals], index=df.columns,columns=df.columns)
fig, axs = plt.subplots(4, 3,  figsize=(40,55))
for i in range(len(db)):
    ...
    axs = axs.ravel()
    axs[i].scatter(tot['1_x'],tot['1_y'],s=50)
    
    axs[i].plot( [0,1],[0,1],"--r" )
    axs[i].set_title('Dataset:'+db[i]+'\n (correlation = ' + str((round(corr.iloc[0,1],2))) +', p-value = '+"{:.2e}".format(pvalue.iloc[0,1])+', number of points = ' + str(len(tot))+')',fontsize=25)
    axs[i].set_xlabel('P-value from Relative abundance', fontsize=25)
    axs[i].set_ylabel('P-value from Presence/Absence', fontsize=25)
    axs[i].set_xlim(tot['1_x'].min(),tot['1_x'].max())
    axs[i].set_ylim(tot['1_y'].min(),tot['1_y'].max())
...
plt.savefig('../results/fig_and_tables/FigS6.eps')
y= list(numbers_boolean.drop('HMP_2012 (oralcavity)').index)
x= list(numbers_boolean.iloc[:,:6].drop('HMP_2012 (oralcavity)')['Abundance'])
x1 = list(numbers_boolean.iloc[:,:6].drop('HMP_2012 (oralcavity)')['Presence/Absence'])
x2=list(numbers_boolean.iloc[:,:6].drop('HMP_2012 (oralcavity)')['Threshold = 0.0001'])
...
ax1.scatter(x,x1)
ax1.plot( [0,1],[0,1],"--r" )
ax1.set_title('Presence/Absence', fontsize=50)

ax1.set_xlim(0,1)
ax1.set_ylim(0,1)
ax2.scatter(x,x2)
ax2.plot( [0,1],[0,1],"--r" )
ax2.set_title('Threshold = 0.0001', fontsize=50)

ax2.set_xlim(0,1)
ax2.set_ylim(0,1)
ax3.scatter(x,x3)
ax3.plot( [0,1],[0,1],"--r" )
ax3.set_title('Threshold = 0.001', fontsize=50)

ax3.set_xlim(0,1)
ax3.set_ylim(0,1)
ax4.scatter(x,x4)
ax4.plot( [0,1],[0,1],"--r" )
ax4.set_title('Threshold = 0.01', fontsize=50)

ax4.set_xlim(0,1)
ax4.set_ylim(0,1)
ax5.scatter(x,x5)
ax5.plot( [0,1],[0,1],"--r" )
ax5.set_title('Threshold = 0.1', fontsize=50)
...
ax6.scatter(x1,x)
ax6.plot( [0,1],[0,1],"--r" )
ax6.set_title('Species level', fontsize=50)

ax6.set_xlim(0,1)
ax6.set_ylim(0,1)
ax7.scatter(x_2,x2)
ax7.plot( [0,1],[0,1],"--r" )
ax7.set_title('Genus level', fontsize=50)

ax7.set_xlim(0,1)
ax7.set_ylim(0,1)
ax8.scatter(x_3,x3)
ax8.plot( [0,1],[0,1],"--r" )
ax8.set_title('Family level', fontsize=50)

ax8.set_xlim(0,1)
ax8.set_ylim(0,1)
ax9.scatter(x_4,x4)
ax9.plot( [0,1],[0,1],"--r" )
ax9.set_title('Order level', fontsize=50)
...
ax10.scatter(x_1,x)
ax10.plot( [0,1],[0,1],"--r" )
ax10.set_title('Lasso classifier', fontsize=50)

ax10.set_xlim(0,1)
ax10.set_ylim(0,1)
ax11.scatter(x_2,x2)
ax11.plot( [0,1],[0,1],"--r" )
ax11.set_title('ENet classifier', fontsize=50)

ax11.set_xlim(0,1)
ax11.set_ylim(0,1)
ax12.scatter(x_3,x3)
ax12.plot( [0,1],[0,1],"--r" )
ax12.set_title('LSVM classifier', fontsize=50)

ax12.set_xlim(0,1)
ax12.set_ylim(0,1)
ax13.scatter(x_4,x4)
ax13.plot( [0,1],[0,1],"--r" )
ax13.set_title('SVM classifier', fontsize=50)

ax13.set_xlim(0,1)
ax13.set_ylim(0,1)
ax14.scatter(x_5,x5)
ax14.plot( [0,1],[0,1],"--r" )
ax14.set_title('RF classifier', fontsize=50)

ax14.set_xlim(0,1)
ax14.set_ylim(0,1)
ax1.tick_params(axis='x', labelsize=1,color='white')
ax1.tick_params(axis='y', labelsize=40)
ax2.tick_params(axis='x', labelsize=1,color='white')
ax2.tick_params(axis='y', labelsize=1,color='white')
ax3.tick_params(axis='x', labelsize=1,color='white')
ax3.tick_params(axis='y', labelsize=1,color='white')
ax4.tick_params(axis='x', labelsize=1,color='white')
ax4.tick_params(axis='y', labelsize=1,color='white')
ax5.tick_params(axis='x', labelsize=1,color='white')
ax5.tick_params(axis='y', labelsize=1,color='white')
ax6.tick_params(axis='x', labelsize=1,color='white')
ax6.tick_params(axis='y', labelsize=40)
ax7.tick_params(axis='x', labelsize=1,color='white')
ax7.tick_params(axis='y', labelsize=1,color='white')
ax8.tick_params(axis='x', labelsize=1,color='white')
ax8.tick_params(axis='y', labelsize=1,color='white')
ax9.tick_params(axis='x', labelsize=1,color='white')
ax9.tick_params(axis='y', labelsize=1,color='white')
ax10.tick_params(axis='x', labelsize=40)
ax10.tick_params(axis='y', labelsize=40)
ax11.tick_params(axis='x', labelsize=40)
ax11.tick_params(axis='y', labelsize=1,color='white')
ax12.tick_params(axis='x', labelsize=40)
ax12.tick_params(axis='y', labelsize=1,color='white')
ax13.tick_params(axis='x', labelsize=40)
ax13.tick_params(axis='y', labelsize=1,color='white')
ax14.tick_params(axis='x', labelsize=40)
ax14.tick_params(axis='y', labelsize=1,color='white')
fig.supxlabel('AUC relative abundance',fontsize=50)
fig.supylabel('AUC presence/absence',fontsize=50)
fig.suptitle('AUC comparison relative abundance vs presence/absence',fontsize=60)
plt.tight_layout()
plt.savefig('../results/fig_and_tables/FigS3.eps')
...
ax1.set_title('Average number of reads vs number of significant species \n correlation = '+"{:.2e}".format(corr.iloc[0,1]),fontsize=25)
ax1.set_xlabel('Average number of reads',fontsize=25)
ax1.set_ylabel('Number of differentially abundant species',fontsize=25)
ax1.tick_params(axis='x', labelsize=20)
ax1.tick_params(axis='y', labelsize=20)
plt.tight_layout()
plt.savefig('../results/fig_and_tables/FigS5.eps')
